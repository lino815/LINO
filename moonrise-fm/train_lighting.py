...
def get_args():
    ...
    parser.add_option('-f', '--folder', dest='folder',
                      default='patches_moonrise_500', help='folder name')
...
if __name__ == '__main__':
    ...
    dir_data = f'data/patches_moonrise_500'
    ...
    model = EMUnet(n_channels=3, n_classes=4)
    # model = UNet_3Plus(in_channels=3, n_classes=4, lr=1e-3)
